...
void EZ_Light::init(int latchPin, int clockPin, int dataPin)
{
...
EZ_Light::EZ_Light(int latchPin, int clockPin, int dataPin)
{
  init(latchPin, clockPin, dataPin);
}

void EZ_Light::digitalWrite(int pin, uint8_t v) {
  digitalWrite(pin, v, true);
}

void EZ_Light::digitalWrite(int pin, uint8_t v, bool doShift) {
